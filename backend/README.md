...
## Project Structure
    ...
    ├── testapiautocatalog_109563  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_109563`
...
2. Clone this repo and `cd testapiautocatalog_109563`
